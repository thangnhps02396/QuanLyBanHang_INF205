...
Public Class frmQLSanPham
    ...
    Private Sub btnSua_Click(sender As Object, e As EventArgs) Handles btnSua.Click
        ...
        Dim stradd As String = "UPDATE SanPham SET MaSP = @MaSP, TenSP = @TenSP, DonGiaSP = @DonGiaSP, SoLuongSP = @SoLuongSP, ChiTietSP = @ChiTietSP, HangSX = @HangSX, LoaiSanPham_MaLoai = @LoaiSanPham_MaLoai Where MaSP = @MaSP"
        ...
        Try
            ...
            com.Parameters.AddWithValue("@DonGiaSP", txtDongia.Text)
            com.Parameters.AddWithValue("@SoLuongSP", NumericUpDown1.Text)
            com.Parameters.AddWithValue("@ChiTietSP", txtChitiet.Text)
            com.Parameters.AddWithValue("@HangSX", txtHangSX.Text)
            com.Parameters.AddWithValue("@LoaiSanPham_MaLoai", txtMaLoai.Text)
            'Thực thi câu truy vấn và sửa dữ liệu trong Database
            com.ExecuteNonQuery()
            'Đóng kết nối
            Ketnoi.Close()
            MessageBox.Show("Sửa thành công!", "Thông tin kết nối", MessageBoxButtons.OK, MessageBoxIcon.Information)
    ...
    Private Sub DataGridView1_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellClick
        ...
        NumericUpDown1.Text = DataGridView1.Item(3, index).Value
        txtChitiet.Text = DataGridView1.Item(4, index).Value
        txtHangSX.Text = DataGridView1.Item(5, index).Value
        txtMaLoai.Text = DataGridView1.Item(6, index).Value
    End Sub
    ...
    Private Sub btnXoa_Click(sender As Object, e As EventArgs) Handles btnXoa.Click
        ...
        Try
            ...
            com.ExecuteNonQuery()
            Ketnoi.Close()
            MessageBox.Show("Xóa thành công!", "Thông tin kết nối", MessageBoxButtons.OK, MessageBoxIcon.Information)
    ...
    Private Sub btnThem_Click(sender As Object, e As EventArgs) Handles btnThem.Click
        ...
        Dim add As New SqlDataAdapter("Insert Into SanPham Values ('" & txtMaSP.Text & "','" & txtTenSP.Text & "','" & txtDongia.Text & "','" & NumericUpDown1.Text & "','" & txtChitiet.Text & "','" & txtHangSX.Text & "','" & txtMaLoai.Text & "')", load)
        Try
            load.Open()
            add.Fill(tb)
            MessageBox.Show("Đã thêm sản phẩm mới!", "Thông tin kết nối", MessageBoxButtons.OK, MessageBoxIcon.Information)
